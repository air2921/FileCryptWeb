...
namespace tests.Controllers_Tests.Core
{
    public class FileController_Test
    {
        ...
        public async Task DeleteFileFromHistory_CacheDeleted_Success()
        {
            ...
            fileRepositoryMock.Setup(x => x.DeleteByFilter(new FileByIdAndRelationSpec(fileId, userId), CancellationToken.None))
            ...
            var result = await fileController.DeleteFileFromHistory(fileId);

            fileRepositoryMock.Verify(repo => repo
                .DeleteByFilter(new FileByIdAndRelationSpec(fileId, userId), CancellationToken.None), Times.Once);
        ...
        public async Task DeleteFileFromHistory_CacheNotDeleted_Success()
        {
            ...
            fileRepositoryMock.Setup(x => x.DeleteByFilter(It.IsAny<FileByIdAndRelationSpec>(), CancellationToken.None))
            ...
            fileRepositoryMock.Verify(repo => repo
                .DeleteByFilter(It.IsAny<FileByIdAndRelationSpec>(), CancellationToken.None), Times.Once);
